      ...
      <section className="relative  overflow-hidden flex justify-center items-center py-14 md:py-20">
        ...
        <div className="z-1 relative flex flex-col lg:flex-row gap-6 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <button className="bg-white/20 bg-blur text-lg capitalize mt-5 lg:mt-auto w-[95vw] rounded-md border-white/10 border-2 sm:w-full py-2 hover:scale-105 active:scale-[1.02] transition focus:scale-105">
              Get Tickets
            </button>
          </div>
        </div>
